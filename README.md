...
- /enchantsword [sharpness] [sweepingEdge] [mending] [unbreaking] [fireAspect] [knockback] [looting] (Enchants any sword you are holding with custom enchantment levels. Very OP!)
...
- /modifyTreeHeight <height> (Changes how tall newly generated trees can be based on height. Only for fun!)
